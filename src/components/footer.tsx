	...
	return (
		<>
			<footer className="border-gradient relative bg-gradient-to-b from-[#08B3CE50] to-transparent">
				<motion.div
					className="mx-auto flex w-full max-w-7xl flex-col items-center justify-center gap-4 px-8 pb-20 pt-5 sm:flex-row sm:justify-between lg:h-[164px] lg:items-start lg:px-20"
